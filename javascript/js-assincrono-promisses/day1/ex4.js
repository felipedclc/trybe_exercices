/* Por fim, o robô Curiosity tem uma taxa de sucesso de envio de mensagem de
60% devido ao fato de o robô já estar muito ocupado com outras operações.
...
function handleError(errorReason) {
    return console.log(`Error getting temperature: ${errorReason}`);
}
